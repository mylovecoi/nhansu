        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption"> DANH SÁCH BUỘC THÔI VIỆC CÁN BỘ - {{$tendv}}</div>
                    <div class="actions">
                            ...
                            @foreach($model as $key=>$value)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url($furl.'maso='.$value->mahts)}}" class="btn btn-success btn-xs mbs">
    ...
    <div id="chitiet-modal" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div class="modal-dialog modal-content">
            <div class="modal-header modal-header-primary">
                ...
                <h4 id="modal-header-primary-label" class="modal-title">DANH SÁCH XÉT HẾT TẬP SỰ</h4>
            </div>
