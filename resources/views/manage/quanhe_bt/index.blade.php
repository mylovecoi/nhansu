        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-list-alt"></i>DANH SÁCH QUAN HỆ GIA ĐÌNH CỦA BẢN THÂN
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form-horizontal">
                    ...
                    <table id="sample_3" class="table table-hover table-striped table-bordered" style="min-height: 230px">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 30%">Thông tin chi tiết</th>
                            <th>Thao tác</th>
                        </tr>
                        </thead>
                            <tbody>
