                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol>
                                ...
                                <li><a href="#" data-target="#chitiet-modal" data-toggle="modal" onclick="baocao('{{$furl.'mausl3'}}')">Báo cáo số lượng đội ngũ cán bộ (Mẫu 2)</a></li>
            ...
            <div class="modal-dialog modal-content">
                ...
                <div class="modal-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"> Khối phòng ban<span class="require">*</span></label>
                            <div class="col-md-8">
                                <select id="makhoipb" name="makhoipb" class="form-control">
                                    <option value="">Tất cả khối phòng ban</option>
                                    @foreach($model_kpb as $kpb)
                                        <option value="{{$kpb->makhoipb}}">{{$kpb->tenkhoipb}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
