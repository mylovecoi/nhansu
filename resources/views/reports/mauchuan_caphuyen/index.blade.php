                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <li><a href="#" data-target="#thoaibcdscb-modal" data-toggle="modal" onclick="baocao('{{$furl.'BcDSTuyenDungTT08'}}')">Báo cáo danh sách cán bộ được tuyển dụng (Mẫu 01/Thông tư 08)</a></li>
                                ...
                                <li><a href="#" data-target="#thoaibcth-modal" data-toggle="modal" onclick="baocaoth('{{$furl.'BcDSCCCVCC'}}')">Báo cáo số lượng, chất lượng cán bộ, công chức huyện (Mẫu 01/TT11)</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
