                    ...
                    <table id="sample_3" class="table table-hover table-striped table-bordered" style="min-height: 230px">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Hình thức</br>đào tạo</th>
                            ...
                            @if(isset($model))
                                @foreach($model as $key=>$value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('/nghiep_vu/qua_trinh/dao_tao/maso='.$value->macanbo)}}" target="_blank"><b>{{$value->tencanbo}}</b></a>
                                        </td>
                                        ...
                                        <td>{{$value->noidung}}</td>
                                        <td>
                                            <a href="{{url('/nghiep_vu/qua_trinh/dao_tao/maso='.$value->macanbo)}}" target="_blank" class="btn btn-info btn-xs mbs"><i class="fa fa-edit"></i>&nbsp; Chỉnh sửa</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
