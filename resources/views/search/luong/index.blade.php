        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">TIÊU CHUẨN TÌM KIẾM THÔNG TIN HỒ SƠ QUÁ TRÌNH HƯỞNG LƯƠNG CÁN BỘ</div>
                    <div class="actions"></div>
                </div>
                    <div class="portlet-body" style="min-height: 380px">
                        {!! Form::open(['url'=>'/tra_cuu/luong/ket_qua','method'=>'POST','id' => 'create-hscb','class'=>'horizontal-form']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!!Form::text('msngbac', null, array('id' => 'msngbac','class' => 'form-control'))!!}
                                        </div>
                                    </div>
                                </div>
                            </div>
