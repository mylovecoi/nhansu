        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">DANH SÁCH BỒI DƯỠNG, ĐÀO TẠO CÁN BỘ - {{$tendv}}</div>
                    <div class="actions">
                        <a href="{{url($furl.'create')}}" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tạo danh sách</a>
